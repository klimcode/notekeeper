...
function writeFile(path, text, successCallback, errCallback) {
    if (!path || !successCallback) return console.error('files__writeFile arguments ERROR: "path" and "successCallback" are required');
    ...
    FS.writeFile(path, content, (err) => {
        if (err) {
            ...
            successCallback();  // ---------------------> exit (file is successfully rewritten or made)
        }
    })
}
